...
/**
 * This is the model class for table "{{organization_region}}".
 *
 * The followings are the available columns in table '{{organization_region}}':
 * @property integer $id
...
class OrganizationRegion extends MyActiveRecord
{
     ...
     * @return OrganizationRegion the static model class
     */
    ...
    {
        return MyHelper::labels('organizationregion');
    }
