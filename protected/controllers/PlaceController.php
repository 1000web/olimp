...
class PlaceController extends Controller
{
    ...
    public function actionCreate($copy = NULL)
    {
        ...
        if (isset($_POST['Place'])) {
            $this->_model->attributes = $_POST['Place'];
            if ($this->_model->save()) {
    ...
    public function actionIndex()
    {
        ...
        $this->_pagesize = $userProfile->place_pagesize;
        $this->buildPageOptions();

        $this->_filter = new Place('search');
        $this->_filter->unsetAttributes(); // clear any default values
        if (isset($_GET['Place'])) $this->_filter->attributes = $_GET['Place'];

        $this->render('index', array(
            'dataProvider' => Place::model()->getAll($userProfile),
        ));
    }
    ...
    public function loadModel($id = NULL)
    {
        ...
        if ($this->_model === NULL) {
            $this->_model = Place::model()->findbyPk($id);
