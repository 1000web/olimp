...
class CountryController extends Controller
{
    ...
    public function actionCreate($copy = NULL)
    {
        ...
        if (isset($_POST['Country'])) {
            $this->_model->attributes = $_POST['Country'];
            if ($this->_model->save()) {
    ...
    public function actionIndex()
    {
        ...
        $this->_pagesize = $userProfile->country_pagesize;
        $this->buildPageOptions();

        $this->_filter = new Country('search');
        $this->_filter->unsetAttributes(); // clear any default values
        if (isset($_GET['Country'])) $this->_filter->attributes = $_GET['Country'];

        $this->render('index', array(
            'dataProvider' => Country::model()->getAll($userProfile),
        ));
    }
    ...
    public function loadModel($id = NULL)
    {
        ...
        if ($this->_model === NULL) {
            $this->_model = Country::model()->findbyPk($id);
